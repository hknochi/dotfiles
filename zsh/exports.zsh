...
# Docker Config
export ECC_DOCKER="docker --tlsverify --tlscacert=$HOME/.config/ssl/docker-eccenca/ca.pem --tlscert=$HOME/.config/ssl/docker-eccenca/client-cert.pem --tlskey=$HOME/.config/ssl/docker-eccenca/client-key.pem "
